...
//     <Link
//       href={post.url}
//       // Added h-full to ensure the card stretches to match its neighbors in the grid
//       className='group relative flex h-full flex-col overflow-hidden rounded-2xl border border-white/5 bg-gray-900/20 p-2 transition-all duration-500 hover:border-emerald-500/30 hover:bg-gray-900/40 hover:shadow-2xl hover:shadow-emerald-500/5'
//     >
//       {/* 1. Image Container - Aspect ratio is fixed, so height is always identical */}
...
//       {/* 2. Content Container - flex-1 is the key here */}
...
//         {/* Title - Fixed height via line-clamp-2 */}
...
//         {/* Description - Fixed height via line-clamp-2 */}
//         <p className='mb-6 line-clamp-2 text-sm leading-relaxed text-gray-400'>
//           {post.description}
//         </p>

//         {/* 3. Footer - mt-auto ensures this is ALWAYS at the very bottom of the card */}
